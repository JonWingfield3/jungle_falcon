...
class SbInstruction : public STypeInstructionInterface {
 public:
  SbInstruction(instr_t instr, RegisterFile& reg_file, MainMemory& mem)
...
class ShInstruction : public STypeInstructionInterface {
 public:
  ShInstruction(instr_t instr, RegisterFile& reg_file, MainMemory& mem)
      : STypeInstructionInterface(instr, reg_file, mem) {
    name_ = "Sh";
  }
...
class SwInstruction : public STypeInstructionInterface {
 public:
  SwInstruction(instr_t instr, RegisterFile& reg_file, MainMemory& mem)
      : STypeInstructionInterface(instr, reg_file, mem) {
    name_ = "Sw";
  }
